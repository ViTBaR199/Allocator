#ifndef DATA_STRUCTURES_CPP_MEMORY_WITH_BORDER_DESCRIPTORS_DEALLOCATION_H
#define DATA_STRUCTURES_CPP_MEMORY_WITH_BORDER_DESCRIPTORS_DEALLOCATION_H
...
class allocator_border_descriptors final :
...
public:
    explicit allocator_border_descriptors(
        size_t memory_size,
    ...
    allocator_border_descriptors(
        allocator_border_descriptors const& other) = delete;

    allocator_border_descriptors& operator=(
        allocator_border_descriptors const& other) = delete;

    ~allocator_border_descriptors() noexcept;
...
private:
    ...
    //Выводит состояние блоков памяти в объекте allocator_border_descriptors (занятые и доступные блоки).
...
private:
    ...
    //Возвращает строку с именем класса (allocator_border_descriptors).
...
#endif //DATA_STRUCTURES_CPP_MEMORY_WITH_BORDER_DESCRIPTORS_DEALLOCATION_H